<script type="text/javascript" charset="utf-8">
    ...
    function addNewVendedorData() {
        ...
        var url = "<?=site_url('vendedor/jsonGuardarNuevo')?>";
    ...
    function fillZonas() {
        $.ajax({
            url: "<?=site_url('vendedor/ajaxGetZonas')?>",
            dataType: "json",
            type: 'GET',
            success: function(json) {
                var options = '';
...
<ul class="breadcrumb">
    ...
    <li>
        <a href="<?=site_url('vendedor')?>">Vendedores</a>
    </li>
    <li>
        <a href="<?=site_url('vendedor/newVendedor')?>">Nuevo Vendedor</a>
    </li>
</ul>
<form>
    <div class="row">
        <div class="box col-md-12">
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-th"></i> Nuevo vendedor</h2>
                    <div class="box-icon">
                ...
                <div class="box-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="control-group cold-md-6">
                                <div class="controls">
                                    <select id="zona" class="selectpicker" data-live-search="true" data-style="btn-primary" multiple>
                                    </select>
                                </div>
                            </div>
                        </div>                        
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="group">
                                <a onclick="addNewVendedorData()" title="Agregar Nuevo Vendedor" data-toggle="tooltip" class="btn btn-primary">
                                    <i class="glyphicon glyphicon-ok-sign"></i> Guardar</a>
                                    <a href="<?= site_url('vendedor/newVendedor')?>" title="Agregar Nuevo Vendedor" data-toggle="tooltip" class="btn btn-warning">
