...
class Pedido extends MY_Controller
{
    ...
    public function ajaxListOrder()
    {
        ...
        $orders = $this->orderModel->getOrderList($year);
    ...
    public function numToLetras($numero, $moneda = '', $subfijo = '')
    {
        $xarray = array(
     ...
     */
    public function subfijo($cifras)
    {
        $cifras = trim($cifras);
    ...
    public function testmoneda()
    {
        ...
        $response = array(
            'leyenda' => $this->num_to_letras($cantidad), 'cantidad' => $cantidad,
            );
        print_r($response);
